...
export const Events = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white shaow1 relative z-20 p-4 md:p-6 spacey24 rounded8 shadow-sm">
        <div>
          ...
          <div className="mt-1 h-[calc(100%-230px)] pr-1 lg:h-[calc(100%-260px)] ">
            <div className="flex justify-end my24">
              <div className="flex gap-4 md:gap-[20px] justify-between md:justify-end items-center w-full md:w-auto">
                <div className="flex-1 md:flex-none">
                  <Dropdown
                    ...
                    className="w-full md:w-[300px] custDropdown1 "
            ...
            <div className="grid grid-cols-1 xl:grid-cols-7 gap-4 md:gap-5 overflow-y-auto  items-stretch">
              ...
              <div className=" col-span-3">
                <div className="h-auto lg:h-[180px] xl:h-[200px] 2xl:h-[210px] 3xl:h-[10.417vw] spacey24 col-span-1 shadow-sm p16 border border-[#f3f5f8] mb-[12px] rounded8 flex">
                  <SimplebarChart />
                </div>
                <div className="h-auto lg:h-[180px] xl:h-[200px] 2xl:h-[210px] 3xl:h-[10.417vw] spacey24 col-span-1 shadow-sm p16 border border-[#f3f5f8] mb-[12px] rounded8 flex">
                  <SimplebarChart />
