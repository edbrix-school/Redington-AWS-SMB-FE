          ...
          <>
            <div className="h-screen flex flex-col">
              <div className="sticky top-0 z-20 shrink-0 bg-white p24">
                <div  onClick={onClose} className="flex gap6 cursor-pointer">
                  <Image
              ...
              <div className="spacey20">
                ...
                <div className="flex w-[75%] ml-auto">
                  <div className="bg-[#fff] px20 py12 rounded8 rounded-tl-none flex justify-end">
                    We’re a 10-person company building a SaaS tool for small
                    retailers.
                  </div>
                </div>
                <div className="flex w-[75%]">
  ...
  "
          ...
          "
                      ...
                      <p className="mt-2 line-clamp-3 font-inter text-[12px] leading-[18px] text-interface-text-subtitle">
                        Redington&apos;s AI-powered solution on AWS that
                        automates and personalizes teaching, assessment, and
                        feedback-enabling scalable, efficient and
                        student-centric education for schools and universities.
                      </p>
                    </div>
