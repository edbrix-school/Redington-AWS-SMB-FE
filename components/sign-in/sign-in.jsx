...
export default function SigninTemplate() {
  ...
  return (
    <>
      <div className="customsignin-gradient fixed inset-0 -z-10 bg-[#fff] mt40">
        <div
        ...
        <div className="grid grid-cols-2 gap20 items-center  h-screen px-[80px] lg:px-[80px] xl:px-[80px] 3xl:px-[4.688vw] py-[80px] lg:py-[80px] xl:py-[80px] 3xl:py-[4.688vw]">
          <div>
                ...
                <div className="py-[26px] ">
                  <div className=" mb-[30px]">
                    <label className="pb-[6px] block font14 font-medium text-InterfaceTexttitle1 ">
                      Email Address <span className="text-Interfacefeedbackerror700">*</span>
                    </label>
                  ...
                  <div className=" ">
                    <label className="pb-[6px] block font14 font-medium text-InterfaceTexttitle1 ">
                      Password <span className="text-Interfacefeedbackerror700">*</span>
                    </label>
                  ...
                  <div  className="flex items-center">
                    <Checkbox onChange={e => setChecked(e.checked)} checked={checked} className="customcheckox"></Checkbox>
                    <div className="inline-block ml-[4px] xl:ml-[4px] 3xl:ml-[0.313vw] text-interfacetextdefault1 font14 font-medium">Remember me</div>
                  </div>
