            ...
            <div className="mx-[20px] xl:mx-[70px] 2xl:mx-[80px] 3xl:mx-[4.271vw] mt-[50px] xl:mt-[60px] 2xl:mt-[75px] 3xl:mt-[3.906vw] mb-[80px] xl:mb-[100px] 2xl:mb-[110px] 3xl:mb-[6.354vw]">
                ...
                <div className=" gap12">
                    <div className="grid grid-cols-10 md:grid-cols-6 lg:grid-cols-11 gap12 mt24">
                        ...
                        <div className="col-span-10 md:col-span-3 lg:col-span-1 see-all-bg flex items-center justify-center p16  space-y-[15px] xl:space-y-[17px] 3xl:space-y-[0.885vw] text-black rounded8 cursor-pointer">
