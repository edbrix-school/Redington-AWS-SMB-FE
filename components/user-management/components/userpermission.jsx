...
export default function PermissionTable({ visible, onHide }) {
  ...
  return (
    <Sidebar
      visible={visible}
      position="right"
      className="!w-[500px] lg:!w-[550px] xl:!w-[580px] 2xl:!w-[35.396vw] 3xl:!w-[36.396vw] customsidebar2 bg-[#F6F7F8] rounded8"
      onHide={onHide}
      dismissable={true}
      blockScroll={true}
    >
      <div className="flex flex-col h-full">
        ...
        <div
          className={`${roboto.variable} p24 bg-[#f5f5f5] flex-1 overflow-y-auto`}
        >
          <table className="w-full border-collapse font14 shadow-sm rounded6 overflow-hidden bg-[#fff]">
            <thead className="bg-[#E5E7EB] ">
              <tr>
                <th className="py12 px20 text-left w-60 text-[#212325]">
                  Items
                </th>
                ...
                <th className="py12 px20 text-center text-[#212325]">
                  Download
                </th>
              </tr>
            </thead>
              ...
              {rows.map((row) => (
                <>
                  <tr className="border-b border-InterfaceStrokesoft1">
                    ...
                    {["read", "create", "edit", "delete", "download"].map(
                      (perm) => (
  ...
  <tr className="bg-[#FAFAFA] border-b border-InterfaceStrokesoft1">
    ...
    {/* Items column (empty under title) */}
    <td className="py-3 pl-10 text-gray-600 text-sm">
      Additional
    </td>
    ...
    <td className="p-3 text-center">
      <Checkbox
        ...
        onChange={() => togglePermission(row.id, "create")}
        className="cursor-pointer customcheckox"
      />
    </td>
    ...
    <td className="p-3 text-center">
      <Checkbox
        ...
        onChange={() => togglePermission(row.id, "edit")}
        className="cursor-pointer customcheckox"
      />
    </td>
    ...
    <td className="p-3 text-center">
      <Checkbox
        checked={row.permissions.download}
        onChange={() => togglePermission(row.id, "download")}
        className="cursor-pointer customcheckox"
      />
    </td>
  </tr>
        ...
        <div className="flex-none bg-[#fff] flex justify-end gap-4 rounded-bl-[10px]">
          <div className=" p-[16px] xl:p-[16px] 3xl:p-[0.833vw] flex justify-end gap-4 rounded-bl-[10px]">
            <div className=" text-[#2C363F]  cancel-btn border-solid border border-[#C9D3DB]  rounded8 py8 px12 flex items-center justify-center cursor-pointer hover:bg-[#f6f6f7]">
              Cancel
            </div>

            <div
              onClick={() => setShow(true)}
              className="font14 py8 px14 font-[500] border-solid border-2  rounded-lg  submit-btn cursor-pointer  text-[#fff] bg-[#645592] hover:bg-[#534880]"
            >
              Submit
            </div>
          </div>
