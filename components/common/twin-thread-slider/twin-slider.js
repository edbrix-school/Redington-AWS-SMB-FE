        ...
        <div className="w-[200px] xl:w-[220px] 3xl:w-[10.417vw] px16 py-[20px] xl:py-[24px] 3xl:py-[1.563vw] ">
          <div className="flex items-center justify-between h-full gap-4">
            <div className="spacey16 px10">
              <Image
                src="/images/svg/twinthread-log.svg"
                width="168"
                height="28"
                alt="logo"
              />
              <div className="text-[#0A291A] font-normal font14">
                TwinThread Industrial AI
              </div>
              <div className="text-[#4C525F99] font-normal leading-[111%] font12">
                ...
                minimal disruption. It guides the crea...
              </div>
            </div>
            <div>
              <Image
                src="/images/twinthread-bg.svg"
                fill
                // width="168"
                // height="28"
                alt="logo"
