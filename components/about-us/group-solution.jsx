...
const GroupSolution = () => {
    return (
        <>
            <div className="">
                <div className="bg-InterfaceSurfacecomponent1 rounded16 p-4 xl:p-[28px] 2xl:p-[30px] 3xl:p-[1.667vw] mx-4 xl:mx-[120px] 2xl:mx-[160px] 3xl:mx-[9.115vw] mt-[30px] xl:mt-[60px] 2xl:mt-[75px] 3xl:mt-[3.906vw] mb-[40px] xl:mb-[100px] 2xl:mb-[110px] 3xl:mb-[6.354vw]">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
                        ...
                        <Link href="" className="text-[#B497FF] border border-[#B497FF] bg-none rounded-full py10 px24 font14 self-start md:self-auto">Show All</Link>
                    </div>
