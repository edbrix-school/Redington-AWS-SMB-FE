      ...
      <div className="bg-[#F0F2F6]">
        <div className="grid grid-cols-12">
          <div className="col-span-6">
            ...
            <div className="text-black text-[20px] xl:text-[22px] 2xl:text-[24px] 3xl:text-[1.25vw] leading-[120%]">One Platform to manage your multi-cloud infrastructure for all partners, vendors and customers</div>
